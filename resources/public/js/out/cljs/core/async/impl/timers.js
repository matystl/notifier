...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_14115 = (0);while(true){
if((i_14115 < arr.length))
{(arr[i_14115] = null);
{
...
{var i_14122 = (self__.level + (1));while(true){
if((i_14122 <= (new_level + (1))))
{(update[i_14122] = self__.header);
{
var G__14123 = (i_14122 + (1));
i_14122 = G__14123;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14124 = (0);while(true){
if((i_14124 <= self__.level))
{var links_14125 = (update[i_14124]).forward;if(((links_14125[i_14124]) === x__$1))
{(links_14125[i_14124] = (x__$1.forward[i_14124]));
{
