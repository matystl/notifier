...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14214 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14214 = (function (val,box,meta14215){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14214.cljs$lang$type = true;
cljs.core.async.impl.channels.t14214.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14214";
cljs.core.async.impl.channels.t14214.cljs$lang$ctorPrWriter = (function (this__4118__auto__,writer__4119__auto__,opt__4120__auto__){return cljs.core._write.call(null,writer__4119__auto__,"cljs.core.async.impl.channels/t14214");
});
cljs.core.async.impl.channels.t14214.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14214.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14216){var self__ = this;
var _14216__$1 = this;return self__.meta14215;
});
cljs.core.async.impl.channels.t14214.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14216,meta14215__$1){var self__ = this;
var _14216__$1 = this;return (new cljs.core.async.impl.channels.t14214(self__.val,self__.box,meta14215__$1));
});
cljs.core.async.impl.channels.__GT_t14214 = (function __GT_t14214(val__$1,box__$1,meta14215){return (new cljs.core.async.impl.channels.t14214(val__$1,box__$1,meta14215));
});
}
return (new cljs.core.async.impl.channels.t14214(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14217 = self__.takes.pop();if((taker_14217 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14217))
{var take_cb_14218 = cljs.core.async.impl.protocols.commit.call(null,taker_14217);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14218,taker_14217,this$__$1){
return (function (){return take_cb_14218.call(null,null);
});})(take_cb_14218,taker_14217,this$__$1))
);
} else
{}
{
...
var putter_14219 = self__.puts.pop();if(!((putter_14219 == null)))
{var put_handler_14220 = putter_14219.handler;var val_14221 = putter_14219.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_14220))
{var put_cb_14222 = cljs.core.async.impl.protocols.commit.call(null,put_handler_14220);var __14223__$1 = cljs.core.async.impl.protocols.commit.call(null,handler);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_14222,__14223__$1,put_handler_14220,val_14221,putter_14219,_,retval,this$__$1){
return (function (){return put_cb_14222.call(null,true);
});})(put_cb_14222,__14223__$1,put_handler_14220,val_14221,putter_14219,_,retval,this$__$1))
);
cljs.core.async.impl.protocols.add_BANG_.call(null,self__.buf,val_14221);
} else
{{
continue;
}
