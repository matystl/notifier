...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14208 = (0);while(true){
var m_14209 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14209 == null))
{} else
{m_14209.call(null);
if((count_14208 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14210 = (count_14208 + (1));
count_14208 = G__14210;
continue;
}
} else
{}
